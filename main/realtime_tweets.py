...
import tool.load_api as load_api
import tool.count_down as count_down
...
save_dir = '/Users/limeilu/PycharmProjects/Twitter_Analysis_for_Earning_Release/utils/data/raw_twitters'
trend_dir = '/Users/limeilu/PycharmProjects/Twitter_Analysis_for_Earning_Release/utils/data/twitter_trend'
...
class RealTimeTweet:
    ...
    #names = pd.read_csv('../utils/dictionary/SP500.csv').Symbol.values
